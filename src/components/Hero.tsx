...
export function HeroSection() {
  ...
  return (
    <div
      className="relative w-full overflow-hidden bg-gradient-to-br from-[#fff5f5] via-white to-[#fff] transition-all"
      id="home"
    >
      ...
      <Container size="xl" className="relative z-10 py-20 md:py-32">
        <div className="relative">
          {/* Optional divider */}
          {/* {!isMobile && (
            <div className="absolute left-1/2 transform -translate-x-1/2 h-[80%] w-px bg-gray-200 opacity-30" />
          )} */}
              ...
              >
                <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-xl p-4">
                  <img
                    ...
                    className="w-full max-w-sm h-auto rounded-xl drop-shadow-lg"
                  />
                </div>
              </motion.div>
            )}
